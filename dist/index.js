  ...
  async onGenerate(options) {
    ...
    if (errorImportPathRaw) {
      ...
      if (modulePath.startsWith(".")) {
        const absoluteErrorPath = node_path_1.default.resolve(
          schemaDir,
          modulePath
        );
        const relativeToOutput = node_path_1.default.relative(
          outputDir,
          absoluteErrorPath
        );
...
function generateModelOperations(models, customError, provider) {
  ...
  return models
    .map((model) => {
      ...
      const errorType = (opErrorType) =>
        customError ? customError.className : opErrorType;
      const mapperFn = (defaultMapper) =>
      ...
      ): Effect.Effect<${resultType("findUnique", true)}, ${errorType(
        "PrismaFindError"
      )}, PrismaClient> =>
        Effect.flatMap(PrismaClient, ({ tx: client }) =>
          Effect.tryPromise({
            try: () => client.${modelNameCamel}.findUnique(args as any)${promiseCast(
        "findUnique",
        true
      )},
            catch: (error) => ${mapperFn(
              "mapFindError"
            )}(error, "findUnique", "${modelName}")
          })
        ),
      ...
      ): Effect.Effect<${resultType("findUniqueOrThrow")}, ${errorType(
        "PrismaFindOrThrowError"
      )}, PrismaClient> =>
        Effect.flatMap(PrismaClient, ({ tx: client }) =>
          Effect.tryPromise({
            try: () => client.${modelNameCamel}.findUniqueOrThrow(args as any)${promiseCast(
        "findUniqueOrThrow"
      )},
            catch: (error) => ${mapperFn(
              "mapFindOrThrowError"
            )}(error, "findUniqueOrThrow", "${modelName}")
          })
        ),
      ...
      ): Effect.Effect<${resultType("findFirst", true)}, ${errorType(
        "PrismaFindError"
      )}, PrismaClient> =>
        Effect.flatMap(PrismaClient, ({ tx: client }) =>
          Effect.tryPromise({
            try: () => client.${modelNameCamel}.findFirst(args as any)${promiseCast(
        "findFirst",
        true
      )},
            catch: (error) => ${mapperFn(
              "mapFindError"
            )}(error, "findFirst", "${modelName}")
          })
        ),
      ...
      ): Effect.Effect<${resultType("findFirstOrThrow")}, ${errorType(
        "PrismaFindOrThrowError"
      )}, PrismaClient> =>
        Effect.flatMap(PrismaClient, ({ tx: client }) =>
          Effect.tryPromise({
            try: () => client.${modelNameCamel}.findFirstOrThrow(args as any)${promiseCast(
        "findFirstOrThrow"
      )},
            catch: (error) => ${mapperFn(
              "mapFindOrThrowError"
            )}(error, "findFirstOrThrow", "${modelName}")
          })
        ),
      ...
      ): Effect.Effect<${resultType("findMany")}, ${errorType(
        "PrismaFindError"
      )}, PrismaClient> =>
        Effect.flatMap(PrismaClient, ({ tx: client }) =>
          Effect.tryPromise({
            try: () => client.${modelNameCamel}.findMany(args as any)${promiseCast(
        "findMany"
      )},
            catch: (error) => ${mapperFn(
              "mapFindError"
            )}(error, "findMany", "${modelName}")
          })
        ),

      create: <A extends PrismaNamespace.Args<${delegate}, 'create'>>(
        args: PrismaNamespace.Exact<A, PrismaNamespace.Args<${delegate}, 'create'>>
      ): Effect.Effect<${resultType("create")}, ${errorType(
        "PrismaCreateError"
      )}, PrismaClient> =>
        Effect.flatMap(PrismaClient, ({ tx: client }) =>
          Effect.tryPromise({
            try: () => client.${modelNameCamel}.create(args as any)${promiseCast(
        "create"
      )},
            catch: (error) => ${mapperFn(
              "mapCreateError"
            )}(error, "create", "${modelName}")
          })
        ),

      createMany: (
        args?: PrismaNamespace.Args<${delegate}, 'createMany'>
      ): Effect.Effect<PrismaNamespace.BatchPayload, ${errorType(
        "PrismaCreateError"
      )}, PrismaClient> =>
        Effect.flatMap(PrismaClient, ({ tx: client }) =>
          Effect.tryPromise({
      ...
      ): Effect.Effect<${resultType("createManyAndReturn")}, ${errorType(
                "PrismaCreateError"
              )}, PrismaClient> =>
        Effect.flatMap(PrismaClient, ({ tx: client }) =>
          Effect.tryPromise({
            try: () => client.${modelNameCamel}.createManyAndReturn(args as any)${promiseCast(
                "createManyAndReturn"
              )},
            catch: (error) => ${mapperFn(
              "mapCreateError"
            )}(error, "createManyAndReturn", "${modelName}")
          })
        ),`
            : ""
        }
      ...
      ): Effect.Effect<${resultType("delete")}, ${errorType(
        "PrismaDeleteError"
      )}, PrismaClient> =>
        Effect.flatMap(PrismaClient, ({ tx: client }) =>
          Effect.tryPromise({
            try: () => client.${modelNameCamel}.delete(args as any)${promiseCast(
        "delete"
      )},
            catch: (error) => ${mapperFn(
              "mapDeleteError"
            )}(error, "delete", "${modelName}")
          })
        ),

      update: <A extends PrismaNamespace.Args<${delegate}, 'update'>>(
        args: PrismaNamespace.Exact<A, PrismaNamespace.Args<${delegate}, 'update'>>
      ): Effect.Effect<${resultType("update")}, ${errorType(
        "PrismaUpdateError"
      )}, PrismaClient> =>
        Effect.flatMap(PrismaClient, ({ tx: client }) =>
          Effect.tryPromise({
            try: () => client.${modelNameCamel}.update(args as any)${promiseCast(
        "update"
      )},
            catch: (error) => ${mapperFn(
              "mapUpdateError"
            )}(error, "update", "${modelName}")
          })
        ),
      ...
      ): Effect.Effect<${resultType("updateManyAndReturn")}, ${errorType(
                "PrismaUpdateManyError"
              )}, PrismaClient> =>
        Effect.flatMap(PrismaClient, ({ tx: client }) =>
          Effect.tryPromise({
            try: () => client.${modelNameCamel}.updateManyAndReturn(args as any)${promiseCast(
                "updateManyAndReturn"
              )},
            catch: (error) => ${mapperFn(
              "mapUpdateManyError"
            )}(error, "updateManyAndReturn", "${modelName}")
          })
        ),`
            : ""
        }
      ...
      ): Effect.Effect<${resultType("upsert")}, ${errorType(
        "PrismaCreateError"
      )}, PrismaClient> =>
        Effect.flatMap(PrismaClient, ({ tx: client }) =>
          Effect.tryPromise({
            try: () => client.${modelNameCamel}.upsert(args as any)${promiseCast(
        "upsert"
      )},
            catch: (error) => ${mapperFn(
              "mapCreateError"
            )}(error, "upsert", "${modelName}")
          })
        ),
      ...
      ): Effect.Effect<${resultType("count")}, ${errorType(
        "PrismaFindError"
      )}, PrismaClient> =>
        Effect.flatMap(PrismaClient, ({ tx: client }) =>
          Effect.tryPromise({
            try: () => client.${modelNameCamel}.count(args as any)${promiseCast(
        "count"
      )},
            catch: (error) => ${mapperFn(
              "mapFindError"
            )}(error, "count", "${modelName}")
          })
        ),
      ...
      ): Effect.Effect<${resultType("aggregate")}, ${errorType(
        "PrismaFindError"
      )}, PrismaClient> =>
        Effect.flatMap(PrismaClient, ({ tx: client }) =>
          Effect.tryPromise({
            try: () => client.${modelNameCamel}.aggregate(args as any)${strongPromiseCast(
        "aggregate"
      )},
            catch: (error) => ${mapperFn(
              "mapFindError"
            )}(error, "aggregate", "${modelName}")
          })
        ),
      ...
      ): Effect.Effect<${resultType("groupBy")}, ${errorType(
        "PrismaFindError"
      )}, PrismaClient> =>
        Effect.flatMap(PrismaClient, ({ tx: client }) =>
          Effect.tryPromise({
            try: () => client.${modelNameCamel}.groupBy(args as any)${strongPromiseCast(
        "groupBy"
      )},
            catch: (error) => ${mapperFn(
              "mapFindError"
            )}(error, "groupBy", "${modelName}")
          })
        )
    }`;
    })
...
async function generateUnifiedService(
  ...
  await promises_1.default.writeFile(
    node_path_1.default.join(outputDir, "index.ts"),
    serviceContent
  );
}
/**
