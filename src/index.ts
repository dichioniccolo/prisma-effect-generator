 ...
 */
function generateModelTypeAliases(
  models: DMMF.Model[],
 ...
 */
function generatePrismaReplicasClass(): string {
  return `/**
 ...
 */
function generateRoutingHelpers(): string {
 ...
 */
function wrapBuildService(body: string): string {
...
async function generateUnifiedService(
  ...
  const modelTypeAliases = generateModelTypeAliases(
    models,
    supportsManyAndReturn,
  );
  const prismaInterface = generatePrismaInterface(
    models,
    customError,
    supportsManyAndReturn,
  );
